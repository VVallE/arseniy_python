...
def register():
    if request.method == 'POST':
        ...
        password = password  # TODO hash this password before save
        try:
            ...
            return "This username is already taken!"  # TODO argument to the register.html page
...
def login():
    if request.method == 'POST':
        ...
        # TODO transform password to hash (sha256 or other)
